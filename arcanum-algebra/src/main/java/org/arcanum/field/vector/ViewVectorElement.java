 ...
 */
public class ViewVectorElement<E extends Element> extends AbstractMatrixElement<E, MatrixField> {

    protected final Matrix base;
    protected final int start, end;

    public ViewVectorElement(AbstractMatrixField field, Matrix base, int start, int end) {
    ...
    public ViewVectorElement(AbstractMatrixField field, Matrix base, int row) {
