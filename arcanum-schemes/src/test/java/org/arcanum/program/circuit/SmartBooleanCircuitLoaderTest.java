...
public class SmartBooleanCircuitLoaderTest {
    ...
    public void testLoad1() throws Exception {
        ...
        BooleanCircuit circuit = loader.load("org/arcanum/program/circuit/bool/smart/comparator_32bit_signed_lteq.txt");
...
//        SmartBooleanCircuitLoader loader = new SmartBooleanCircuitLoader();
//        BooleanCircuit circuit = loader.load("org/arcanum/circuit/AES-non-expanded.txt");
//
